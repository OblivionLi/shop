...
import ProductParentCategoryPaginate from "../../../components/ProductParentCategoryPaginate";
...
const ProductsListByParentCategoryScreen = ({ history, match }) => {
    const classes = useStyles();
    const dispatch = useDispatch();

    const type = match.params.type;
    const pCat = match.params.pCat;
    const previousParentCat = pCat;
    ...
    useEffect(() => {
        if (pCat === previousParentCat) {
            setLoad(true);
        }

        axios
            .get(`/api/products/type/${type}/parent-category/${pCat}?page=${page}`, {
                params: selected,
            })
            .then((response) => {
        ...
        axios
            .get(`/api/brands/type/${type}/parent-category/${pCat}`, {
        ...
        axios
            .get(`/api/colors/type/${type}/parent-category/${pCat}`, {
        ...
        axios
            .get(`/api/sizes/type/${type}/parent-category/${pCat}`, {
            ...
            <section className="wrapper">
                ...
                >
                    ...
                    <Link
                        ...
                        to={`/products/${type}/parent-category/${pCat}`}
                        aria-current="page"
                    >
                        {pCat.toUpperCase()}
                    </Link>
                        ...
                        {load ? (
                            ...
                            <>
                                <div className="product-list--products-filter">
                                    <p>Products List by Parent Category <NavigateNextIcon fontSize="small" /> {pCat.toUpperCase()}</p>
                                    <h3>
...
export default ProductsListByParentCategoryScreen;
